...
func (x *WhoiamRequest) GetSessionId() string {
	if x != nil {
		return x.SessionId
	}
	return ""
...
const file_service_service_proto_rawDesc = "" +
	...
	"\x06tokens\x18\x02 \x01(\v2\x12.service.v1.TokensR\x06tokens\x12-\n" +
	"\aaccount\x18\x03 \x01(\v2\x13.service.v1.AccountR\aaccount\"1\n" +
	"\x0eRefreshRequest\x12\x1f\n" +
	"\vrefresh_jwt\x18\x01 \x01(\tR\n" +
	"refreshJwt\"=\n" +
	"\x0fRefreshResponse\x12*\n" +
	"\x06tokens\x18\x01 \x01(\v2\x12.service.v1.TokensR\x06tokens\".\n" +
	"\rWhoiamRequest\x12\x1d\n" +
	"\n" +
	"session_id\x18\x01 \x01(\tR\tsessionId\"?\n" +
	"\x0eWhoiamResponse\x12-\n" +
	"\aaccount\x18\x01 \x01(\v2\x13.service.v1.AccountR\aaccount\".\n" +
	"\rLogoutRequest\x12\x1d\n" +
	"\n" +
	"session_id\x18\x01 \x01(\tR\tsessionId\"\x10\n" +
	"\x0eLogoutResponse2\xd1\x02\n" +
	"\x04Auth\x12E\n" +
	"\bRegister\x12\x1b.service.v1.RegisterRequest\x1a\x1c.service.v1.RegisterResponse\x12<\n" +
	"\x05Login\x12\x18.service.v1.LoginRequest\x1a\x19.service.v1.LoginResponse\x12B\n" +
	"\aRefresh\x12\x1a.service.v1.RefreshRequest\x1a\x1b.service.v1.RefreshResponse\x12?\n" +
	"\x06Whoiam\x12\x19.service.v1.WhoiamRequest\x1a\x1a.service.v1.WhoiamResponse\x12?\n" +
	"\x06Logout\x12\x19.service.v1.LogoutRequest\x1a\x1a.service.v1.LogoutResponseB\xb5\x01\n" +
	"\x0ecom.service.v1B\fServiceProtoP\x01ZLgithub.com/m11ano/budget_planner/backend/auth/pkg/proto_pb/service;servicev1\xa2\x02\x03SXX\xaa\x02\n" +
	"Service.V1\xca\x02\n" +
...
var file_service_service_proto_goTypes = []any{
	(*Tokens)(nil),           // 0: service.v1.Tokens
	(*Account)(nil),          // 1: service.v1.Account
	(*RegisterRequest)(nil),  // 2: service.v1.RegisterRequest
	(*RegisterResponse)(nil), // 3: service.v1.RegisterResponse
	(*LoginRequest)(nil),     // 4: service.v1.LoginRequest
	(*LoginResponse)(nil),    // 5: service.v1.LoginResponse
	(*RefreshRequest)(nil),   // 6: service.v1.RefreshRequest
	(*RefreshResponse)(nil),  // 7: service.v1.RefreshResponse
	(*WhoiamRequest)(nil),    // 8: service.v1.WhoiamRequest
	(*WhoiamResponse)(nil),   // 9: service.v1.WhoiamResponse
	(*LogoutRequest)(nil),    // 10: service.v1.LogoutRequest
	(*LogoutResponse)(nil),   // 11: service.v1.LogoutResponse
}
var file_service_service_proto_depIdxs = []int32{
	0,  // 0: service.v1.LoginResponse.tokens:type_name -> service.v1.Tokens
	1,  // 1: service.v1.LoginResponse.account:type_name -> service.v1.Account
	0,  // 2: service.v1.RefreshResponse.tokens:type_name -> service.v1.Tokens
	1,  // 3: service.v1.WhoiamResponse.account:type_name -> service.v1.Account
	2,  // 4: service.v1.Auth.Register:input_type -> service.v1.RegisterRequest
	4,  // 5: service.v1.Auth.Login:input_type -> service.v1.LoginRequest
	6,  // 6: service.v1.Auth.Refresh:input_type -> service.v1.RefreshRequest
	8,  // 7: service.v1.Auth.Whoiam:input_type -> service.v1.WhoiamRequest
	10, // 8: service.v1.Auth.Logout:input_type -> service.v1.LogoutRequest
	3,  // 9: service.v1.Auth.Register:output_type -> service.v1.RegisterResponse
	5,  // 10: service.v1.Auth.Login:output_type -> service.v1.LoginResponse
	7,  // 11: service.v1.Auth.Refresh:output_type -> service.v1.RefreshResponse
	9,  // 12: service.v1.Auth.Whoiam:output_type -> service.v1.WhoiamResponse
	11, // 13: service.v1.Auth.Logout:output_type -> service.v1.LogoutResponse
